        ...
        <div>
            <nav className="navbar navbar-expand-lg bg-light py-3 shadow-sm bg-white">
                <div className="container">
                    <NavLink className="navbar-brand fw-bold fs-3" to="/">Bigtime</NavLink>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                       ...
                       <div className="buttons">
                        ...
                        <NavLink to="/selling" className="btn btn-outline-dark ms-2"><i className="fa fa-user-plus  me-1"></i> Start Selling</NavLink>
